...
try {
    ...
    log('template.cot(4249):<@DISPLAY@> Error exists in path expression.');
    throw ex;
}
var value;
try {
    ...
    log('template.cot(4249):<@DISPLAY@> Error exists in arguments.');
    throw ex;
}
try {
   print(value);
} catch (ex) {
    log('template.cot(4249):<@DISPLAY@> Error exists in command.');
    throw ex;
}
currentItem = currentItemStack.pop();
// END OF DISPLAY
...
try {
    ...
    log('template.cot(4259):<@DISPLAY@> Error exists in path expression.');
    throw ex;
}
var value;
try {
    ...
    log('template.cot(4259):<@DISPLAY@> Error exists in arguments.');
    throw ex;
}
try {
   print(value);
} catch (ex) {
    log('template.cot(4259):<@DISPLAY@> Error exists in command.');
    throw ex;
}
currentItem = currentItemStack.pop();
// END OF DISPLAY
...
try {
    ...
    log('template.cot(4283):<@DISPLAY@> Error exists in path expression.');
    throw ex;
}
var value;
try {
    ...
    log('template.cot(4283):<@DISPLAY@> Error exists in arguments.');
    throw ex;
}
try {
   print(value);
} catch (ex) {
    log('template.cot(4283):<@DISPLAY@> Error exists in command.');
    throw ex;
}
currentItem = currentItemStack.pop();
// END OF DISPLAY
...
try {
    ...
    log('template.cot(4291):<@DISPLAY@> Error exists in path expression.');
    throw ex;
}
var value;
try {
    ...
    log('template.cot(4291):<@DISPLAY@> Error exists in arguments.');
    throw ex;
}
try {
   print(value);
} catch (ex) {
    log('template.cot(4291):<@DISPLAY@> Error exists in command.');
    throw ex;
}
currentItem = currentItemStack.pop();
// END OF DISPLAY
...
try {
    ...
    log('template.cot(4302):<@DISPLAY@> Error exists in path expression.');
    throw ex;
}
var value;
try {
    ...
    log('template.cot(4302):<@DISPLAY@> Error exists in arguments.');
    throw ex;
}
try {
   print(value);
} catch (ex) {
    log('template.cot(4302):<@DISPLAY@> Error exists in command.');
    throw ex;
}
currentItem = currentItemStack.pop();
// END OF DISPLAY
...
try {
    ...
    log('template.cot(4311):<@REPEAT@> Error exists in  path expression.');
    throw ex
}
try {
    eval('var elemArr1 = getAllElements(false, rootElem, \'UMLModel\', \'\', \'\')');
}catch (ex) {
    log('template.cot(4311):<@REPEAT@> Error exists in path, type, collection name.');
    throw ex
}
try {
    for (var i1 = 0, c1 = elemArr1.length; i1 < c1; i1++ ) {
        ...
        try {
            ...
            log('template.cot(4312):<@DISPLAY@> Error exists in path expression.');
            throw ex;
        }
        var value;
        try {
            ...
            log('template.cot(4312):<@DISPLAY@> Error exists in arguments.');
            throw ex;
        }
        try {
           print(value);
        } catch (ex) {
            log('template.cot(4312):<@DISPLAY@> Error exists in command.');
            throw ex;
        }
        currentItem = currentItemStack.pop();
        // END OF DISPLAY
    ...
    log('template.cot(4311):<@REPEAT@> Error exists in command.');
    throw ex;
}
currentItem = currentItemStack.pop();
// END OF REPEAT
