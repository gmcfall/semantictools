...
function RdfClass_normalizeRestrictions() {
  ...
  for (var i=0; i<list.length; i++) {
    ...
    if (!r.preserve && r.property.rangeList.length == 1) {
       ...
       * range declared in the property, then we will null it out.
       */
...
function RdfEnum(ontology, name, extensible) {
...
function RdfRestriction(property, domain, range, minCardinality, maxCardinality) {
  this.property = property;
  this.domain = domain;
  this.range = range;
...
//  var uri = this.ontology.uri + name;
  ...
  var restriction = new RdfRestriction(property, domain, range, minCardinality, maxCardinality);
...
function OntologyBuilder_buildEnums(umlPackage) {
  ...
  for (var i=0; i<list.length; i++) {
    var umlEnum = list[i];
    var rdfEnum = new RdfEnum(this.ontology, umlEnum.name, umlEnum.isExtensible);
...
function OntologyBuilder_buildClass(type) {
  ...
  if (stereotype == "enumeration") {
    type.rdfEnum = new RdfEnum(this.ontology, type.name, true);
...
try {
    ...
    log('template.cot(4023):<@DISPLAY@> Error exists in path expression.');
    throw ex;
}
var value;
try {
    ...
    log('template.cot(4023):<@DISPLAY@> Error exists in arguments.');
    throw ex;
}
try {
   print(value);
} catch (ex) {
    log('template.cot(4023):<@DISPLAY@> Error exists in command.');
    throw ex;
}
currentItem = currentItemStack.pop();
// END OF DISPLAY
...
try {
    ...
    log('template.cot(4033):<@DISPLAY@> Error exists in path expression.');
    throw ex;
}
var value;
try {
    ...
    log('template.cot(4033):<@DISPLAY@> Error exists in arguments.');
    throw ex;
}
try {
   print(value);
} catch (ex) {
    log('template.cot(4033):<@DISPLAY@> Error exists in command.');
    throw ex;
}
currentItem = currentItemStack.pop();
// END OF DISPLAY
...
try {
    ...
    log('template.cot(4057):<@DISPLAY@> Error exists in path expression.');
    throw ex;
}
var value;
try {
    ...
    log('template.cot(4057):<@DISPLAY@> Error exists in arguments.');
    throw ex;
}
try {
   print(value);
} catch (ex) {
    log('template.cot(4057):<@DISPLAY@> Error exists in command.');
    throw ex;
}
currentItem = currentItemStack.pop();
// END OF DISPLAY
...
try {
    ...
    log('template.cot(4065):<@DISPLAY@> Error exists in path expression.');
    throw ex;
}
var value;
try {
    ...
    log('template.cot(4065):<@DISPLAY@> Error exists in arguments.');
    throw ex;
}
try {
   print(value);
} catch (ex) {
    log('template.cot(4065):<@DISPLAY@> Error exists in command.');
    throw ex;
}
currentItem = currentItemStack.pop();
// END OF DISPLAY
...
try {
    ...
    log('template.cot(4076):<@DISPLAY@> Error exists in path expression.');
    throw ex;
}
var value;
try {
    ...
    log('template.cot(4076):<@DISPLAY@> Error exists in arguments.');
    throw ex;
}
try {
   print(value);
} catch (ex) {
    log('template.cot(4076):<@DISPLAY@> Error exists in command.');
    throw ex;
}
currentItem = currentItemStack.pop();
// END OF DISPLAY
...
try {
    ...
    log('template.cot(4085):<@REPEAT@> Error exists in  path expression.');
    throw ex
}
try {
    eval('var elemArr1 = getAllElements(false, rootElem, \'UMLModel\', \'\', \'\')');
}catch (ex) {
    log('template.cot(4085):<@REPEAT@> Error exists in path, type, collection name.');
    throw ex
}
try {
    for (var i1 = 0, c1 = elemArr1.length; i1 < c1; i1++ ) {
        ...
        try {
            ...
            log('template.cot(4086):<@DISPLAY@> Error exists in path expression.');
            throw ex;
        }
        var value;
        try {
            ...
            log('template.cot(4086):<@DISPLAY@> Error exists in arguments.');
            throw ex;
        }
        try {
           print(value);
        } catch (ex) {
            log('template.cot(4086):<@DISPLAY@> Error exists in command.');
            throw ex;
        }
        currentItem = currentItemStack.pop();
        // END OF DISPLAY
    ...
    log('template.cot(4085):<@REPEAT@> Error exists in command.');
    throw ex;
}
currentItem = currentItemStack.pop();
// END OF REPEAT
